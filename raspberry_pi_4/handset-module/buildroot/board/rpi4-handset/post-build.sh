...
cp board/rpi4-handset/firmware/regulatory.db $TARGET_DIR/lib/firmware/regulatory.db
cp board/rpi4-handset/firmware/regulatory.db.p7s $TARGET_DIR/lib/firmware/regulatory.db.p7s
